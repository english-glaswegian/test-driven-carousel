...
describe('Carousel', () => {
  ...
  describe('component with HOC', () => {
    ...
    it('advances the slide time after `autoAdvanceDelay` elapses', () => {
      jest.useFakeTimers();
      const autoAdvanceDelay = 10e3;
      mounted = mount(
        <Carousel autoAdvanceDelay={autoAdvanceDelay} slides={slides} />
      );
  ...
  describe('core component', () => {
    // Tests against core carousel will go here
